...
- Think step-by-step: what could realistically break after this change?
...
- Document what was actually checked in the commit message or PR description
...
- [ ] Smoke check performed in browser / Postman (if UI or API affected)
